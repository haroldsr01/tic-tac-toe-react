...
export const Room = (props) => {
    ...
    return (
        <tr>
            ...
            <td><button disabled={props.room.players[1] === null ? true : props.user.username ===props.room.host || props.user.username === props.room.players[1] ? false : true} className='btn-play' onClick={()=>props.navigate(`/auth/play/room/${props.room._id}`)}>PLAY</button></td>
